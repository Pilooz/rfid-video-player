...
if (CONFIG.rfid.behavior == "emulated") {
  ...
  var testList = [ {tag: "coderfid2", reader:2}, {tag:"presentation", reader:1}, {tag:"coderfid1", reader:1}, {tag: "coderfid3", reader:3}, {tag: "coderfid4", reader:1}, {tag: "coderfid5", reader:2}];
  var i = 0;
